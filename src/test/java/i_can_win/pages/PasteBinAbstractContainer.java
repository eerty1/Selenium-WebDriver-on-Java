...
public abstract class PasteBinAbstractContainer {
    protected final int WAIT_TIMEOUT_SECONDS = 10;

    protected static void makeTheProgramWaitPresenceOfElementLocated(WebDriver driver, int time, String xpath) {
