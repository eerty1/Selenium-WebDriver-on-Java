...
import bring_it_on.service.TestDataReader;
...
public class PasteBinCreatePastePage extends PasteBinAbstractContainer {
    ...
    private static final String XPATH_FOR_PASTE_SYNTAX_SELECTOR = "//*[@id='select2-postform-format-container']";
    private static final String XPATH_BASH_SYNTAX = "//li[text()='Bash']";
    ...
    @FindBy(xpath = XPATH_FOR_PASTE_SYNTAX_SELECTOR)
    private WebElement pasteSyntaxSelector;

    @FindBy(xpath = XPATH_BASH_SYNTAX)
    ...
    public PasteBinCreatePastePage fillPastForm() {
        ...
        pastFormArea.sendKeys(TestDataReader.readProperties("data.for.past.form"));
        return this;
    }
    ...
    public PasteBinCreatePastePage setSyntaxHighlighting() {
        makeTheProgramWaitElementToBeClickable(DRIVER, WAIT_TIMEOUT_SECONDS, XPATH_FOR_PASTE_SYNTAX_SELECTOR);
        pasteSyntaxSelector.click();
        makeTheProgramWaitElementToBeClickable(DRIVER, WAIT_TIMEOUT_SECONDS, XPATH_BASH_SYNTAX);
        bashSyntax.click();
        return this;
    }
    ...
    public PasteBinCreatePastePage fillPostName() {
        ...
        pasteNameInput.sendKeys(TestDataReader.readProperties("paste.name"));
        return this;
    }
